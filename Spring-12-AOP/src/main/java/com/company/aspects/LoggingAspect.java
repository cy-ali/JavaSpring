...
public class LoggingAspect {
    ...
    @Pointcut("execution(* com.company.controller.ProductController.*(..))")
    ...
    @Before("execution(* com.company.controller.ProductController.*(..))")
...
//    execution
    @Pointcut("execution(* com.company.controller.ProductController.up*(..))")
    private void anyUpdateOperation(){}

    @Pointcut("execution(* com.company.repository.ProductRepository.findById(Long))")
